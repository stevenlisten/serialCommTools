...
## 开发与维护必读
**`docs/开发流程总结.md`** 是本项目唯一权威开发与维护手册（766 行）：
项目总览、11 条工作协议、技术架构与设计决策、环境/测试/发布流程、缺陷模式库（15 项）、故障排查手册、性能基准、
数据格式规范、代码地图（函数行号索引）、环境自检、任务 Runbook、凭据与写作规范、设计决策记录。
**新 AI 会话/新维护者开工前必读本文件**（阅读顺序见文件开头）。
